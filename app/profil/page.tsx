                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div>
                      ...
                      <ul className="space-y-3 text-sm">
                        <li className="flex justify-between border-b border-outline/20 pb-2"><span className="text-on-surface-variant">Belum/Tidak Sekolah</span><span className="font-medium text-on-surface">968</span></li>
                        ...
                        <li className="flex justify-between border-b border-outline/20 pb-2"><span className="text-on-surface-variant">SMP</span><span className="font-medium text-on-surface">626</span></li>
                        <li className="flex justify-between border-b border-outline/20 pb-2"><span className="text-on-surface-variant">SMA/SMK</span><span className="font-medium text-on-surface">691</span></li>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="md:col-span-6 lg:col-span-12">
              <AnimateIn delay={0.3} direction="up">
                <div className="bg-secondary-container/10 rounded-3xl p-8 md:p-10 border border-secondary/20">
